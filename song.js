document.addEventListener("DOMContentLoaded", function() {
  ...
  searchButton.addEventListener('click', function() {
    ...
    const filteredResults = searchData.filter(function(song) {
  ...
  function displayResults(results) {
    ...
    results.forEach(function(result) {
      ...
      resultItem.addEventListener('click', function() {
        const selectedSong = musicFiles.find(function(song) {
          return song.title.toLowerCase() === result.toLowerCase();
        });
        if (selectedSong) {
          ...
          // Update currently playing song, duration, and genre
          currentSong.textContent = selectedSong.title;
          songDuration.textContent = selectedSong.duration;
          songGenre.textContent = selectedSong.genre;
        }
      });
